...
ADMINS = (
    ('Ahmed Boussadia', 'ahmed@mastercourses.com'),
	('Elias Baoudj', 'elias@mastercourses.com')
)
...
SECRET_KEY = 'vv-@g+5aia)ysq&+vb0sn%^sj)h6*5vc&388=qoj_e&y)ws@4h'
...
ROOT_URLCONF = 'beta_invitation.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'beta_invitation.wsgi.application'
